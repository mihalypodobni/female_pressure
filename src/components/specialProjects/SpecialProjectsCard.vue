        ...
        <b-row class="p-0 justify-content-start align-items-center">
          ...
          <b-col cols="7" sm="7" md="9" lg="7" class="p-0 my-3">
            <div class="p-0">
              ...
              <div v-if="!$store.state.isMobile" class="project-text p-0">
                {{ project.text }}
              </div>
            </div>
          </b-col>
...
.project-card
  ...
  border: none
  outline: 2px solid #00DFB8
  box-shadow: 0 2.4px 6.8px rgba(0, 0, 0, 0.016),0 19px 54px rgba(0, 0, 0, 0.05)
  color: black
  &:hover
      box-shadow: 0 2.3px 3.4px rgba(0, 0, 0, 0.106),0 18px 27px rgba(0, 0, 0, 0.12)
      outline: 4px solid #3EFFC5  
      border-radius: 0
